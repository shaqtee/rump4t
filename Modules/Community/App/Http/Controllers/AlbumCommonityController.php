...
class AlbumCommonityController extends Controller
{
    protected $api;
    protected $helper;
    protected $interface;
    ...
    public function __construct(ApiResponse $api, Helper $helper, CommunityInterface $interface, AlbumCommonity $model)
    {
        $this->api = $api;
        $this->helper = $helper;
    ...
    {
        try {
            $show = $this->model->with(['photoCommonity'])->find($id);
