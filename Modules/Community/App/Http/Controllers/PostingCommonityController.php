...
class PostingCommonityController extends Controller
{
    protected $api;
    protected $helper;
    protected $interface;
    ...
    public function __construct(ApiResponse $api, Helper $helper, CommunityInterface $interface, PostingCommonity $model)
    {
        $this->api = $api;
        $this->helper = $helper;
    ...
    public function store(Request $request)
    {
        DB::beginTransaction();
        try {
            $request['title'] = $this->helper->removeAndCheckNewLine($request->title);
