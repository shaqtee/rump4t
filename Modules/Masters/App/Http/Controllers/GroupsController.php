...
class GroupsController extends Controller
{
    ...
    public function __construct(ApiResponse $api, Helper $helper, MastersInterface $interface, Group $model)
    {
        $this->api = $api;
        $this->helper = $helper;
    ...
    public function store(Request $request)
    {
        DB::beginTransaction();
        try {
            $isExists = $this->model->where('name', $request->name)->exists();

            if($isExists){
                return $this->api->error("Group name already exists.");
            }
    ...
    public function update(Request $request, $id)
    {
        DB::beginTransaction();
        try {
            $isExists = $this->model->where('id', '!=', $id)->where('name', $request->name)->exists();
