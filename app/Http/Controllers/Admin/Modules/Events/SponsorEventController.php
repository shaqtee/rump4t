...
class SponsorEventController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            $data = [
                'content' => 'Admin/Event/Supporting-Partner/index',
                'title' => 'Data Supporting Partner',
                'sponsors' =>  $this->model->with(['sponsorEvent'])->whereNotNull('t_event_id')->filter($request)->orderByDesc('id')->paginate($page)->appends($request->all()),
    ...
    public function create()
    {
        try{
            $data = [
                'content' => 'Admin/Event/Supporting-Partner/addEdit',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->store('event.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('event.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            $model->delete();
            DB::commit();
            return $this->web->destroy('event.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
