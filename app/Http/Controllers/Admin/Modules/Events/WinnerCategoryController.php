...
namespace App\Http\Controllers\Admin\Modules\Events;

use App\Models\User;
use App\Exceptions\Handler;
use Illuminate\Http\Request;
use App\Services\WebRedirect;
use App\Models\WinnerCategory;
use App\Services\Helpers\Helper;
use Illuminate\Support\Facades\DB;
use App\Http\Controllers\Controller;
use App\Models\WinCatUserSponsor;
...
class WinnerCategoryController extends Controller
{
    protected $model;
    protected $helper;
    protected $handler;
    ...
    public function index(Request $request, $id)
    {
        try{
            $data = [
                'content' => 'Admin/Event/Winner-Category/index',
    ...
    public function create()
    {
        try{
            $data = [
                'content' => 'Admin/Event/Winner-Category/addEdit',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->store('event.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function edit($id)
    {
        try{
            ...
            $data = [
                ...
                'eventWinner' =>  $this->event->with([
                                                    'winnerCategory' => function($q) {
                                                        $q->with(['usersWinner', 'masterWinnerCategory'])->orderBy('sort','ASC');
                                                    },
                                                ])->orderByDesc('id')->findOrfail($id),
    ...
    public function _edit(string $id)
    {
        try{
            $data = [
                'content' => 'Admin/Event/Winner-Category/_addEdit',
                'title' => 'Edit Winner Category',
    ...
    public function _update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('event.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->destroy('event.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
