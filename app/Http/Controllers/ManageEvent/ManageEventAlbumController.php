...
class ManageEventAlbumController extends Controller
{
    protected $model;
    protected $helper;
    protected $handler;
    ...
    public function index(Request $request, $event_id)
    {
        try{
            ...
            $data = [
                'content' => 'ManageEven/Event/Album/index',
                'title' => 'Data Album',
    ...
    public function create($event_id)
    {
        try{
            $data = [
                'content' => 'ManageEven/Event/Album/addEdit',
                'title' => 'Create Album',
                'albums' => null,
                'event' => $this->event->findOrfail($event_id),
            ];
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->successReturn('event.manage-event.album.photo.semua', 'album_id', $model->id, 'Berhasil Menambah Data, Silahkan Tambahkan Photo');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('event.manage-event.album.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->destroy('event.manage-event.album.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
    ...
    public function photo_index(Request $request, $id)
    {
        try{
            $page = $request->size ?? 10;
            $data = [
                'content' => 'ManageEven/Event/Album/Photo/index',
                'title' => 'Data Photo',
    ...
    public function photo_create($album_id)
    {
        try{
            $data = [
                'content' => 'ManageEven/Event/Album/Photo/addEdit',
    ...
    public function photo_destroy(string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->destroy('event.manage-event.album.photo.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
