...
class ManageEventController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            $data = [
                'content' => 'ManageEvent/Event/index',
                'title' => 'Data Event',
    ...
    public function index_community(Request $request)
    {
        try{
            $page = $request->size ?? 10;
            $data = [
                'content' => 'ManageEvent/Community/Event/index',
                'title' => 'Data Event',
    ...
    public function show_community(string $event_id)
    {
        try{
            $data = [
                'content' => 'ManageEvent/Community/Event/show',
                'title' => 'Show Event',
    ...
    public function create()
    {
        try{
            $data = [
                'content' => 'ManageEvent/Event/addEdit',
                'title' => 'Create Event',
                'event' => null,
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->store('event.manage.manage-event.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('event.manage.manage-event.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->destroy('event.manage.manage-event.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
    ...
    public function index_registrant(Request $request, $event_id){
        try{
            $page = $request->size ?? 10;
            $data = [
                'content' => 'ManageEvent/Event/listRegistrant',
    ...
    public function leaderboard($id)
    {
        try{
            ...
            $data = [
                'content' => 'ManageEvent/Event/leaderboard',
                'title' => 'Leaderboard',
                'leaderboard' => $result,
            ];
