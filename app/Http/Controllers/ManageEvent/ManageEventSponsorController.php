...
class ManageEventSponsorController extends Controller
{
    protected $model;
    protected $helper;
    protected $handler;
    ...
    public function index(Request $request, $event_id)
    {
        try{
            ...
            $data = [
                'content' => 'ManageEvent/Event/Supporting-Partner/index',
    ...
    public function create($event_id)
    {
        try{
            $data = [
                'content' => 'ManageEvent/Event/Supporting-Partner/addEdit',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->successReturn('event.manage-event.sponsor.semua', 'event_id', $model->t_event_id);
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function edit(string $id)
    {
        try{
            $data = [
                ...
                'sponsors' => $this->model->with(['sponsorEvent', 'socialMedia'])->findOrfail($id),
            ];
            return view('ManageEvent.Layouts.wrapper', $data);
        } catch (\Throwable $e) {
            return $this->handler->handleExceptionWeb($e);
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->updateReturn('event.manage-event.sponsor.semua', 'event_id', $model->t_event_id);
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
