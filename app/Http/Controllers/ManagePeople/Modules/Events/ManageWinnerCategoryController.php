...
class ManageWinnerCategoryController extends Controller
{
    protected $model;
    protected $helper;
    protected $handler;
    ...
    public function index(Request $request, $id)
    {
        try{
            $data = [
                'content' => 'ManagePeople/Event/Winner-Category/index',
    ...
    public function create()
    {
        try{
            $data = [
                'content' => 'ManagePeople/Event/Winner-Category/addEdit',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->store('event.manage.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function _edit(string $id)
    {
        try{
            $data = [
                'content' => 'ManagePeople/Event/Winner-Category/_addEdit',
                'title' => 'Edit Winner Category',
    ...
    public function _update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('event.manage.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->destroy('event.manage.winners.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
