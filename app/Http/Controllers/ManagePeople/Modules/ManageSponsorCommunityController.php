...
class ManageSponsorCommunityController extends Controller
{
    protected $model;
    protected $helper;
    protected $handler;
    ...
    public function index(Request $request)
    {
        try{
            ...
            $data = [
                'content' => 'ManagePeople/Community/Supporting-Partner/index',
                'title' => 'Data Supporting Partner',
                'sponsors' =>  $this->model->with(['socialMedia'])->where('t_community_id', auth()->user()->t_community_id)->orderByDesc('id')->paginate($page),
            ];
    ...
    public function create()
    {
        try{
            $data = [
                'content' => 'ManagePeople/Community/Supporting-Partner/addEdit',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->store('community.manage.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            DB::commit();
            return $this->web->update('community.manage.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            if($e instanceof ValidationException){
                return $this->web->error_validation($e);
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            $model->delete();
            DB::commit();
            return $this->web->destroy('community.manage.sponsor.semua');
        } catch (\Throwable $e) {
            DB::rollBack();
            return $this->handler->handleExceptionWeb($e);
        }
