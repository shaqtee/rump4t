                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            ...
                            @error('nickname')
                                <small style="color: red">{{ $message }}</small>
                            @enderror
                            <input type="text" class="form-control @error('nickname') is-invalid @enderror"  value="{{ old('nickname', isset($users) ? $users->nickname : '') }}" name="nickname" id="nickname" placeholder="Nickname" required autofocus>
                        </div>
                        <div class="form-group">
