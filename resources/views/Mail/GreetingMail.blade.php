                ...
                <td class="wrapper" valign="top">
                  ...
                  <table class="dgolf-wrapper" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
					  ...
					  <p class="welcome-msg">Selamat bergabung di DGolf!</p>
						<p class="normal-teks">Hi {{ $dataUser->name }}!</p>
						<p class="normal-teks">Akun Anda sudah kami aktifkan. Anda mendaftar menggunakan email <span style="color:#00A551;">{{ $dataUser->email }}</span>. Masukkan email dan password yang Anda daftarkan tersebut setiap kali login di aplikasi DGolf.</p>
