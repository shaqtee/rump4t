                  ...
                  <table class="dgolf-wrapper" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td class="wrap-td" valign="top">
						...
						<p class="normal-teks">Kami telah menerima permintaan Registrasi pada akun Anda.<br>
						Untuk mengkonfirmasi permintaan Anda, mohon masukkan Kode OTP berikut:</p>
						<p class="otp-number">{{ $user->otp_code }}</p>
						<p class="normal-teks">Abaikan email ini jika Anda tidak pernah meminta untuk Registrasi.</p>
