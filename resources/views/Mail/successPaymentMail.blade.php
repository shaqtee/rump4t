...
@media all {
  ...
  #gradient2 {
	  background-image: linear-gradient(to right, #00A551, #140958); height:10px;}
  #gradient3 {
	  background-image: linear-gradient(to right, #00A551, #140958); height:130px; padding:35px 50px;}
  ...
  .driving{font-family: sans-serif; font-ssize: 20px; vertical-align: top;}
  ...
  .otp-number{font-family: sans-serif; font-size: 35px; font-weight:s bold; margin-top: 10px; margin-bottom: 35px; border-radius: 20px; background-color:#00A551;width:200px; text-align:center; color:white;}
        ...
        <td class="container" width="680" valign="top">
          <div class="content">
            ...
            <table  role="presentation" class="main" width="100%">
             <tr><th id="gradient2" colspan="2"></th></tr> 
			
              <th style="text-align:left; width:50%;" class="logodgolf"><img src="http://dgolf-be.aksiteknologi.com/images/logo-dgolf3.png"/></th><th>Transaction No: <span style="color:#00A551; text-align:right;">{{ $datas->voucher }}</span></th>
		</table>
<table  role="presentation" class="main" width="100%">
                  ...
                  <table class="dgolf-wrapper" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td class="wrap-td" valign="top">
                        <p class="welcome-msg">Hi {{ $datas->user->name }}!</p>
						<p class="normal-teks">Terima kasih Anda telah menyelesaikan pembayaran event {{ $datas->event->title }}.</p>
						...
						<p class="normal-teks">Salam Hangat </br>
						D’Golf</p>
                      </td>
                    </tr>
					</table>
