<div class="mt-3">
    <div class="card  box-shadow-0 ">
        ...
        <div class="card-body pt-0">
            @if (isset($sponsors))
                <form action="{{ route('event.manage-event.sponsor.ubah', ['id' => $sponsors->id]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
            @else
                <form action="{{ route('event.manage-event.sponsor.tambah') }}" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                    <div class="row">
                        <div class="col">
