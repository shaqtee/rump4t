                        ...
                        <tbody>
                            @foreach ($eventWinner->winnerCategory as $winnerCategory)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('event.manage-event.winners.ubah', ['id' => $winnerCategory->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <select name="t_user_id" class="form-control select2"
                                                                @if (isset($winnerCategory->name) && !empty($winnerCategory->name)) disabled @endif
                                                                id="t_user_id_{{ $winnerCategory->id }}">
                                                                <option selected value="">Select User Winner
                                                                </option>
                                                    ...
                                                    <div class="row cid_{{ $winnerCategory->id }} @if (!isset($winnerCategory->name) && empty($winnerCategory->name)) hide @endif"
                                                        ...
                                                        <div class="col-md-8 mt-2">
                                                            <input type="text"
                                                                ...
                                                                name="name"
                                                                value="{{ old('name', isset($winnerCategory) ? $winnerCategory->name : '') }}"
