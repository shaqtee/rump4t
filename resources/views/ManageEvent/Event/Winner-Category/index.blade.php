                    ...
                    <tbody>
                        {{-- @foreach ($eventWinner as $evWin) --}}
                            <tr>
                                ...
                                <td>
                                    {{-- <div class="d-flex"> --}}
                                        <a class="btn btn-info " href="{{ route('event.manage-event.winners.ubah', ['id' => $eventWinner->id]) }}">EDIT</a>
                                        {{-- <form action="{{ route('event.manage-event.winners.hapus', ['id' => $eventWinner->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
