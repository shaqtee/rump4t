    ...
    <div class="card mg-b-20">
        <div class="card-header pb-0">
            ...
            <div class="row justify-content-start">
                <div class="col-auto">
                    <a href="{{ route('event.manage.album.photo.viewtambah', ['album_id' => $albums->id]) }}" class="btn btn-success  d-flex align-items-center justify-content-center"><i class="fa fa-plus"></i> ADD</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($photos as $key => $ph)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-info " href="{{ route('event.manage.album.photo.ubah', ['id' => $ph->id]) }}">EDIT</a>
                                        <form action="{{ route('event.manage.album.photo.hapus', ['id' => $ph->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
