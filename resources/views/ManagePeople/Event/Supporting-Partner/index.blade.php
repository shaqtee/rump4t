    ...
    <div class="card mg-b-20">
        <div class="card-header pb-0">
            ...
            <div class="row justify-content-start">
                <div class="col-auto">
                    <a href="{{ route('event.manage.sponsor.viewtambah', ['event_id' => $event->id]) }}" class="btn btn-success  d-flex align-items-center justify-content-center"><i class="fa fa-plus"></i> ADD</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($sponsors as $key => $spsr)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-info " href="{{ route('event.manage.sponsor.ubah', ['id' => $spsr->id]) }}">EDIT</a>
